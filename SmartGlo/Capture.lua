...
--
-- Vendored. The SavedVariables SHAPE is the hard contract; everything below this header
-- is not. Kept byte-identical to the other copies on purpose, so a diff between them shows
